package com.lamastudio.backend.billing.jobs;
...
import com.lamastudio.backend.shared.jobs.SubscriptionExpiryReminderJob;
...
class SubscriptionExpiryReminderJobTest {
    ...
    void expiringManualSubscription_sendsReminder() {
        ...
        com.lamastudio.backend.shared.entity.User user = new com.lamastudio.backend.shared.entity.User();
